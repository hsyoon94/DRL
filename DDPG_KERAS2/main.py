...
from UADDPG.uaddpg import UADDPG
...
def main(args=None):
    ...
    elif(args.type=="DDPG" or args.type=="UADDPG"):
    ...
    elif (args.type == "UADDPG"):
        algo = UADDPG(action_dim, state_dim, act_range, args.consecutive_frames)
